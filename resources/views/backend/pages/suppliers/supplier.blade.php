        ...
        <div class="col-12">
            <div class="card w-100">
                <div class="card-body p-4">
                    ...
                    <div class="table">
                        <table class="table text-nowrap mb-0 align-middle" id="supplier">
...
<script>
    ...
    function render(data = '') {
        ...
        let datatable = $('#supplier').DataTable({
            processing: true,
            serverSide: true,
            language: {
            ...
            columnDefs: [{
                ...
                },
                {
                    ...
                    render: function(col, type, row) {
                        return (`
                                            ...
                                            <h6 class="fw-semibold mb-0">${row.supplier_name}</h6>
                                        </td>
                ...
                },
                {
                    ...
                    render: function(col, type, row) {
                        return (`
                            <td class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0">${row.supplier_address}</h6>
                                        </td>
                        `);
                    },
                    targets: 2
                },
                {
                    ...
                    render: function(col, type, row) {
                        return (`
                            <td class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0">${row.supplier_phone}</h6>
                                        </td>
                        `);
                    },
                    targets: 3
